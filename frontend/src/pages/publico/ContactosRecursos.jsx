    ...
    <div className="min-h-screen bg-[#DCEAF7] flex flex-col justify-between font-sans text-slate-800">
      ...
      <main className="max-w-4xl mx-auto px-6 py-6 w-full flex-1 flex flex-col items-center">
        ...
        <div className="w-full flex items-center justify-between mb-4">
          <button onClick={() => navigate("/informacion")} className="text-[#2C5F57] hover:text-[#1F433D] p-1">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-md border border-slate-100 w-full max-w-2xl space-y-6">
          <div>
            <h2 className="text-[#2C5F57] font-bold text-lg mb-1">Tarjetas de contacto</h2>
          ...
          <div className="space-y-4 pt-2">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="font-bold text-slate-800 text-sm italic">Orientador/a escolar</p>
                <p className="text-xs text-slate-700 font-bold italic">Apoyo para situaciones de bullying, conflictos y bienestar emocional.</p>
              </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="font-bold text-slate-800 text-sm italic">Profesor/a de confianza</p>
                <p className="text-xs text-slate-700 font-bold italic">Habla con un docente con quien te sientas seguro/a.</p>
              </div>
              <span className="p-2 bg-emerald-500 text-white rounded-md shrink-0">📞</span>
            </div>
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="font-bold text-slate-800 text-sm italic">Línea de ayuda</p>
                <p className="text-xs text-slate-700 font-bold italic">Encuentra líneas y servicios de atención disponibles para recibir orientación.</p>
              </div>
              <span className="p-2 bg-emerald-500 text-white rounded-md shrink-0">📞</span>
            </div>
          </div>

...
export default function RegistroDocente() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white font-sans text-slate-800">
      {/* Columna Izquierda: Formulario Sign Up */}
      <div className="w-full md:w-1/2 flex flex-col justify-between p-8 md:p-16">
        <div className="max-w-md w-full mx-auto my-auto space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-2">
            ...
            <button
              type="submit"
              className="w-full bg-[#0088CC] hover:bg-[#0077B5] text-white font-medium py-2.5 rounded-lg text-sm transition-colors mt-4"
            >
              Get started
            </button>
          </form>
          ...
          <p className="text-center text-xs text-slate-500 pt-2">
            ...
            <Link to="/docente/login" className="text-[#0088CC] font-semibold hover:underline">
              Log in
            </Link>
          </p>
        </div>

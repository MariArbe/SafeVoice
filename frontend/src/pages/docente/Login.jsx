      ...
      <div className="w-full md:w-1/2 flex flex-col justify-between p-8 md:p-16">
        <div className="max-w-md w-full mx-auto my-auto space-y-6">
          ...
          <div className="text-center space-y-1.5">
            ...
            <p className="text-sm text-slate-500">¡Bienvenido/a de nuevo! Ingresa tus credenciales para acceder.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 pt-2">
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 text-slate-600 cursor-pointer select-none">
                <input
                  ...
                  className="rounded border-slate-300 text-[#1B5E9E] focus:ring-[#1B5E9E] w-4 h-4 cursor-pointer"
                />
                Recordarme
              </label>
              <a href="#" className="text-[#1B5E9E] font-medium hover:underline">
            ...
            <button
              type="submit"
              className="w-full bg-[#1B5E9E] hover:bg-[#154a7d] active:scale-[0.99] text-white font-semibold py-2.5 rounded-xl text-sm transition-all shadow-sm mt-2 cursor-pointer"
            >
              Ingresar
            </button>
          </form>
          ...
          <p className="text-center text-xs text-slate-500 pt-2">
            ...
            <Link to="/docente/registro" className="text-[#1B5E9E] font-semibold hover:underline">
              Regístrate aquí
            </Link>
          </p>
        </div>
